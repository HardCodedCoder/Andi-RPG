class_name GameVictory

extends Control


@onready var again_button = $MarginContainer/HBoxContainer/VBoxContainer/RetryButton as Button
@onready var back_button = $MarginContainer/HBoxContainer/VBoxContainer/BackButton as Button

@onready var restart_level = preload("res://scenes/start_scene.tscn") as PackedScene
